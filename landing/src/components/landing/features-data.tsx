...
export function IconServer(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={props.className} aria-hidden>
      <path
        d="M4 6a2 2 0 012-2h12a2 2 0 012 2v3a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM4 15a2 2 0 012-2h12a2 2 0 012 2v3a2 2 0 01-2 2H6a2 2 0 01-2-2v-3z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      <path
...
export function IconBackup(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={props.className} aria-hidden>
      <path
        d="M7 18a4 4 0 01-.88-7.903A5 5 0 1115.9 6H16a5 5 0 011 9.9M15 13l-3 3m0 0l-3-3m3 3V9"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
export function IconDocker(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={props.className} aria-hidden>
      <path
        d="M4 14h3v3H4v-3zm4 0h3v3H8v-3zm4 0h3v3h-3v-3zm-8-4h3v3H4v-3zm4 0h3v3H8v-3zm4 0h3v3h-3v-3zm4 0h3v3h-3v-3zM8 6h3v3H8V6zm4 0h3v3h-3V6z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M3 17.5C3 19.5 5.5 21 12 21s9-1.5 9-3.5c0-1.2-.8-2.1-2.2-2.7"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function IconRestore(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={props.className} aria-hidden>
      <path
        d="M4 12a8 8 0 0114.95-4M20 12a8 8 0 01-14.95 4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function IconArrows(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={props.className} aria-hidden>
      <path
...
export function IconRelay(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={props.className} aria-hidden>
      <path
        d="M4 7h7a3 3 0 013 3v0a3 3 0 01-3 3H8"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M20 17h-7a3 3 0 01-3-3v0a3 3 0 013-3h3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
/** Full explanations for /features. */
export const detailedFeatures: readonly DetailedFeature[] = [
  {
    id: "from-to",
...
export const LAZYBRO_LINUX_ARM64_URL = `${GITHUB_URL}/releases/download/lazybro/lazybro-linux-arm64`;
export const LAZYBRO_MACOS_ARM64_URL = `${GITHUB_URL}/releases/download/lazybro/lazybro-darwin-arm64`;
